...
module.exports = {
  ...
  get TT_USERNAME()        { return process.env.TIKTOK_USERNAME || ''; },
  ...
  TT_IMAGES:   path.join(BASE_DIR, 'data', 'images', 'tt'),
  ...
  TT_CACHE_FILE:   path.join(BASE_DIR, 'data', 'tt_cache.json'),
  TT_HISTORY_FILE: path.join(BASE_DIR, 'data', 'tt_history.json'),
